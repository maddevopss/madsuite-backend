...
router.get('/processing-activities', (req, res, next) => handle(res, next, async () => (await db.query('SELECT * FROM privacy_processing_activities WHERE organisation_id=$1 ORDER BY created_at DESC', [org(req)])).rows));
