...
const requireKey = (req, res) => { if (!key(req) || String(key(req)).trim().length < 8) { res.status(400).json({ code: 'cybersecurity.idempotency_required' }); return false; } return true; };
